        ...
        <div className="absolute  w-full h-full  flex flex-col items-center justify-between">
          ...
          <div>
            <button
              ...
              className={`px-4 md:px-8 py-2 md:py-3 bg-primaryColor text-black sm:text-xl text-sm rounded-t-lg ${isRental ? "font-bold shadow-resale_shadow " : "font-normal"
                }`}
            >
              Rental
            </button>
            <button
              ...
              className={`px-4 md:px-8 py-2 md:py-3 bg-primaryColor text-black sm:text-xl text-sm ml-5 rounded-t-lg   ${isRental ? "font-normal  " : "font-bold shadow-resale_shadow"
                }`}
            >
              Resale
            </button>
