      ...
      <div>
        ...
        <div className="sm:mt-20 mt-8 md_link:px-20 px-4 ">
          ...
          <div className="mt-8 grid sm:grid-cols-12 grid-cols-6 gap-10">
            ...
            <div className="col-span-6 flex flex-col gap-5">
              <p className="text-center font-bold ">Ajay K Singh (Director)</p>
              <p className="text-base text-secondaryLightColor font-light text-justify">Ajay is the Business Head of Investay Realty. He has been leading Sales and sourcing at Century Real Estate for over 3 years, and is among the most dynamic leaders in the real estate sector at the moment. He is responsible for driving the targeted topline growth of 2X every 2 years at Century. As a part of the leadership team of Century Real estate, he is also responsible for strengthening and growing brand Century into a profitable premium real estate brand.</p>
              <p className="text-base text-secondaryLightColor font-light text-justify">Ajay comes with over 17 years of experience across FMCG, media and real estate companies, including the recently listed Shriram Properties.

</p>
<p className="text-base text-secondaryLightColor font-light text-justify">Investay Realty Services LLP, the brain child of Ajay, is a subsidiary company of Century Real Estate, aimed at providing a one stop solution for all property related needs of investors and property seekers. It's unique value proposition makes it all set for multifold growth in the coming 3-4 years.
