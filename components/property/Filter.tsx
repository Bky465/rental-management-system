...
export const Filter = ({ isDisable, properties, setProperties, myproperties, loading, filter, setFilter, filterProperties }: TProps) => {
    ...
    switch (field) {
      case "preferredTenants":
        !filter.preferredTenants.includes(value)
          ...
          : setFilter({
              ...filter,
              preferredTenants: filter.preferredTenants.filter((item: any) => item !== value),
            });
        break;
      case "tenancyStatus":
        !filter.tenancyStatus.includes(value)
          ...
          : setFilter({
              ...filter,
              tenancyStatus: filter.tenancyStatus.filter((item: any) => item !== value),
            });
        break;
      case "furnishingStatus":
        !filter.furnishingStatus.includes(value)
          ...
          : setFilter({
              ...filter,
              furnishingStatus: filter.furnishingStatus.filter((item: any) => item !== value),
            });
        break;
      case "parking":
      ...
      case "directionFacing":
        !filter.directionFacing.includes(value)
          ...
          : setFilter({
              ...filter,
              directionFacing: filter.directionFacing.filter((item: any) => item !== value),
            });
        break;
      case "propertyType":
        !filter.propertyType.includes(value)
          ...
          : setFilter({
              ...filter,
              propertyType: filter.propertyType.filter((item: any) => item !== value),
            });
        break;
      case "constructionStatus":
        !filter.constructionStatus.includes(value)
          ...
          : setFilter({
              ...filter,
              constructionStatus: filter.constructionStatus.filter((item: any) => item !== value),
            });
        break;
      default:
        break;
                            ...
                            <div key={ind}>
                              <div className="flex justify-between mt-4">
                                ...
                                <input
                                  ...
                                  onChange={()=> handleChange({field: myfield,value})}
                                />
                              </div>
                            </div>
                          );
