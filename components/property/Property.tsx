...
const Property = ({ property }: any) => {
  ...
  useEffect(() => {
    if (router.isReady && property?._id) {
      const data = property?.gallery.filter(
        (item: any) =>
  ...
  return (
    <>
      ...
      <div className="col-span-4 h-full  shadow-md flex flex-col rounded-lg overflow-hidden">
        <div className="h-48 xxs:h-[15.2rem] w-full relative overflow-hidden">
          ...
          {/* <div className="w-full h-full flex justify-center items-center rounded-t-lg bg-[#DCDCDC]">
            <div className="w-full h-full flex justify-center items-center rounded-t-lg bg-[#DCDCDC]">
              {gallery?.length > 0 ? (
                <img
                  src={`/assets/uploads/images/${gallery[index].link}`}
                  alt="Property"
                  className="h-full w-full"
                />
              ) : (
              ...
              <span onClick={() => handleBackWard()}>
                <ChevronLeftIcon
                  className={`w-5 h-5  cursor-pointer ${
                    false ? "text-gray-400" : "text-white"
                  }`}
                />
              </span>
              <span onClick={() => handleForward(Object.values(gallery))}>
                <ChevronRightIcon
                  className={`w-5 h-5  cursor-pointer ${
                    false ? "text-gray-400" : "text-white"
                  }`}
        ...
        <div className=" mt-1 xxs:mt-4 mb-8 capitalize">
          <div className="px-2 lg1:px-6">
          ...
          <div className="px-2 lg1:px-6 mt-2 flex items-start justify-between">
            <div className="flex gap-x-4">
              ...
              <div className="space-y-2">
                <p className="text-xs font-normal">{property?.projectName}</p>
            ...
            <div className="col-span-6 gap-2 flex flex-col ">
              ...
              <div className="flex justify-between items-center ">
                ...
                <p className=" text-xs ml-10 capitalize">
