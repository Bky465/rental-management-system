    ...
    <>
      ...
      <div className="3xl:h-[65rem] lg:h-[40rem]   xs:h-[25rem] h-[15rem] grid xl:grid-cols-12 grid-cols-6 gap-2 xl:gap-x-2">
        <div className="col-span-6 h-full overflow-hidden">
          {gallery.length > 0 ? (
            <img
              src={`/assets/uploads/images/${gallery[0].link}`}
        ...
        <div className="col-span-6 h-full overflow-hidden flex xl:flex-col flex-row gap-2 justify-center items-center">
          {gallery.length > 0 ? (
            <>
              {gallery.length > 1 ? (
                <img
                  src={`/assets/uploads/images/${gallery[1].link}`}
              ...
              {gallery.length > 2 ? (
                ...
                >
                  <img
                    src={`/assets/uploads/images/${gallery[2].link}`}
        ...
        {/* <div className="col-span-6 lg:h-[40.5rem] ">
          {gallery.length > 0 ? (
            <img
              src={`/assets/uploads/images/${gallery[0].link}`}
              className="w-full h-full "
        ...
        <div className="col-span-6 h-fit grid grid-cols-12 gap-2 xl:gap-y-2 ">
          {gallery.length > 0 ? (
            <>
              <div className="xl:col-span-12 col-span-6 md:h-[20rem] xs:h-[15rem] h-[10rem]">
                <img
                  src={`/assets/uploads/images/${gallery[1].link}`}
                  className="w-full h-full"
                  alt="gallery-image"
              ...
              <div
                className="relative xl:col-span-12 col-span-6  bg-CardImg] md:h-[20rem] xs:h-[15rem] h-[10rem] cursor-pointer"
                onClick={() => setOpen(true)}
              >
                <img
                  src={`/assets/uploads/images/${gallery[2].link}`}
                  ...
                  alt="gallery-image"
                />
                <div className="absolute inset-0 h-[100%] w-[100%] flex justify-center items-center bg-[#ffffff89]">
                  <GrAdd className="h-8 w-8" />
                </div>
              </div>
            </>
            ...
            <>
              <div className="xl:col-span-12 col-span-6 flex justify-center items-center md:h-[20rem] xs:h-[15rem] h-[10rem] bg-[#dcdcdc]">
                <img
                  src="/assets/images/noImg1.svg"
                  className="w-[6rem] h-[6rem] xs:w-[9rem] xs:h-[9rem] md:w-[10rem] md:h-[10rem] lg1:w-[12rem] lg1:h-[12rem]"
                  alt="gallery-image"
                />
              </div>
              <div className="xl:col-span-12 col-span-6 flex justify-center items-center md:h-[20rem] xs:h-[15rem] h-[10rem] bg-[#dcdcdc]">
